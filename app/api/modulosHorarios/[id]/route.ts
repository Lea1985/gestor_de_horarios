...
import { obtenerModulo, ModuloNoEncontradoError as ObtenerNotFound } from "@/lib/usecases/modulosHorarios/obtenerModulo"
import { actualizarModulo, ModuloNoEncontradoError as ActualizarNotFound, SinCamposError, HorasInvalidasError, SolapamientoError } from "@/lib/usecases/modulosHorarios/actualizarModulo"
import { eliminarModulo } from "@/lib/usecases/modulosHorarios/eliminarModulo"
...
export async function PATCH(
  ...
  return withContext(req, async ({ tenantId }) => {
    ...
    try {
      ...
      if (error instanceof SinCamposError || error instanceof HorasInvalidasError) {
